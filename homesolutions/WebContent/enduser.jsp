        ...
        <div id="left">
            ...
            <form action="">
                <div id="bt">
                    ...
                    <div class="details" id="details1" style="text-align:center;"><span style="color:black;">${firstname}</span></div>
                </div>
                <div id="bt">
                    <button >Last Name</button>
                    <div class="details" id="details2" style="text-align:center;"><span style="color:black;">${lastname}</span></div>
                </div>

                <div id="bt">
                    <button  >Phone Number</button>
                    <div class="details" id="details3" style="text-align:center;"><span style="color:black;">${contnum}</span></div>
                </div>
                <div id="bt">
                    <button >Address</button>
                    <div class="details" id="details4" style="text-align:center;"><span style="color:black;">${address}</span></div>
                </div>
                <div id="bt">
                    <button >City</button>
                    <div class="details" id="details5" style="text-align:center;"><span style="color:black;">${city}</span></div>
                </div>
                <div id="bt">
                    <button >State</button>
                    <div class="details" id="details6" style="text-align:center;"><span style="color:black;">${state}</span></div>
                </div>
                <div id="bt">
                    <button >Pincode</button>
                    <div class="details" id="details7" style="text-align:center;"><span style="color:black;">${pincode}</span></div>
                </div>
                <div id="bt">
                    <button  >Signed up as</button>
                    <div class="details" id="details8" style="text-align:center;"><span style="color:black;">${signedupasa}</span></div>
                </div>
                <div id="bt">
                    <button >Gender</button>
                    <div class="details" id="details9" style="text-align:center;"><span style="color:black;">${gender}</span></div>
                </div>
            ...
            <div id="registeruserlist">
                <div id="registeruser">
                    ...
                    <div id="info">
                        ...
                        %>
                            <a href="userpage2.jsp?contnum=<%=resultset.getString("contnum")%>&&pincode=<%=request.getAttribute("pincode")%>&&cont=<%=request.getAttribute("contnum")%>" >Select</a>
                             <%}
                        else {
